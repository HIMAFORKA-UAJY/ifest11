    ...
    >
      <div className="mx-auto flex flex-col items-center justify-center px-6 py-10 lg:w-11/12 lg:flex-row lg:gap-8 2xl:w-7/12">
        ...
        <div className="flex-col lg:basis-1/2">
          ...
          <div className="flex flex-col flex-wrap gap-2 px-10 py-4 text-center font-retroica text-sm text-white lg:w-full lg:flex-row lg:gap-6 lg:px-0">
          ...
          <div className="flex justify-center lg:justify-start">
            <Link href={content.url}>
              ...
              >
                {/* {content.abbreviation === "MUC" || content.name === "Seminar Nasional"
                  ? "Coming Soon"
                  : "Read More"} */}
                Read More
              </button>
